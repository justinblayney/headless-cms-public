...
import { getWildPage, getHomeSlides, getAllPostsForLanding } from '../lib/api'
  ...
  return (
    <>
	  ...
	  <meta property="og:title" content={ page.seo.title } />
				...
				<meta property="og:image" content="https://res.cloudinary.com/djk8wzpz4/image/upload/v1612801845/justin-blayney-fox_geu4tx.jpg" />
				<meta property="og:image:secure_url" content="https://res.cloudinary.com/djk8wzpz4/image/upload/v1612801845/justin-blayney-fox_geu4tx.jpg" />
				<meta property="og:image:type" content="image/jpeg" />
				<meta property="og:image:width" content="822" />
				<meta property="og:image:height" content="550" />
				<meta property="og:image:alt" content="Justin Blayney Fine Art Pixelated Fox" />
        ...
        <ContainerFull>
	      ...
	      <Col className="wrap-carousel">
				...
				<MyCarousel 
	  					finearts={finearts} 
	  					imageQuery={(arts) => arts.fineartfields.fineseries === 'Wildlife / Landscapes'} 
	  			/>
		  ...
		  <Row>
			...
			<Row>					
				...
				{finearts.nodes 
							...
							arts.fineartfields.fineseries === 'Wildlife / Landscapes' ?

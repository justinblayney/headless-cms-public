...
import { getSilkPage, getHomeSlides, getAllPostsForLanding } from '../lib/api'
  ...
  return (
    <>
	  ...
	  <meta property="og:title" content={ page.seo.title } />
				...
				<meta property="og:image" content="https://res.cloudinary.com/djk8wzpz4/image/upload/v1611611659/Jerry-full_rwfmn8.jpg" />
				<meta property="og:image:secure_url" content="https://res.cloudinary.com/djk8wzpz4/image/upload/v1611611659/Jerry-full_rwfmn8.jpg" />
				<meta property="og:image:type" content="image/jpeg" />
				<meta property="og:image:width" content="410" />
				<meta property="og:image:height" content="550" />
				<meta property="og:image:alt" content="Justin Blayney Fine Art, Jerry Garcia print" />
        ...
        <ContainerFull>
	      ...
	      <Col className="wrap-carousel">
				...
				<MyCarousel 
	  					finearts={finearts} 
	  					imageQuery={(arts) => arts.fineartfields.fineseries === 'Silk Screen Prints'} 
	  			/>
	  ...
	  <Container className="pad-row-bottom">
			...
			<Row>	
				...
				{finearts.nodes 
							...
							arts.fineartfields.fineseries === 'Silk Screen Prints' ?

...
import { getOpticalPage, getHomeSlides, getAllPostsForLanding } from '../lib/api'
  ...
  return (
    <>
	  ...
	  <meta property="og:title" content={ page.seo.title } />
				...
				<meta property="og:image" content="https://res.cloudinary.com/djk8wzpz4/image/upload/v1611270043/orange_on_blue_chrome_lg-e1611270024874_i0ws1d.jpg" />
				<meta property="og:image:secure_url" content="https://res.cloudinary.com/djk8wzpz4/image/upload/v1611270043/orange_on_blue_chrome_lg-e1611270024874_i0ws1d.jpg" />
				<meta property="og:image:type" content="image/jpeg" />
				<meta property="og:image:width" content="559" />
				<meta property="og:image:height" content="550" />
				<meta property="og:image:alt" content="Justin Blayney Fine Art Pixelated painting" />
        ...
        <ContainerFull>
	      ...
	      <Col className="wrap-carousel">
				...
				<MyCarousel 
	  					finearts={finearts} 
	  					imageQuery={(arts) => arts.fineartfields.fineseries === 'Op Art Patterns'} 
	  			/>
	  ...
	  <Container className="pad-row-bottom">
			...
			<Row>
				...
				{finearts.nodes 
							...
							arts.fineartfields.fineseries === 'Op Art Patterns' ?
...
export async function getStaticProps({ preview = false }) {
  ...
  const data = await getOpticalPage()

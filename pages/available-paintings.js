...
import { getAvailablePage, getHomeSlides, getAllPostsForLanding } from '../lib/api'
	  ...
	  <meta property="og:title" content={ page.seo.title } />
        ...
        <ContainerFull>
	      ...
	      <Col className="wrap-carousel">
				...
				<MyCarousel 
	  					finearts={finearts} 
	  					imageQuery={(arts) => arts.fineartfields.fineavailable === 'Yes'} 
	  			/>
	  ...
	  <Container className="pad-row-bottom">
			...
			<Row>		
				...
				{finearts.nodes 
							...
							arts.fineartfields.fineavailable === 'Yes' ?
...
export async function getStaticProps({ preview = false }) {
  ...
  const data = await getAvailablePage()

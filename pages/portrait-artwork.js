...
import { getPortPage, getHomeSlides, getAllPostsForLanding } from '../lib/api'
  ...
  return (
    <>
	  ...
	  <meta property="og:title" content={ page.seo.title } />
				...
				<meta property="og:image" content="https://res.cloudinary.com/djk8wzpz4/image/upload/v1611180870/MCA-pixel-portrait_jqm50p.jpg" />
				<meta property="og:image:secure_url" content="https://res.cloudinary.com/djk8wzpz4/image/upload/v1611180870/MCA-pixel-portrait_jqm50p.jpg" />
				<meta property="og:image:type" content="image/jpeg" />
				<meta property="og:image:width" content="550" />
				<meta property="og:image:height" content="722" />
				<meta property="og:image:alt" content="Justin Blayney Fine Art Pixelated MCA Portrait" />
        ...
        <ContainerFull>
	      ...
	      <Col className="wrap-carousel">
				...
				<MyCarousel 
	  					finearts={finearts} 
	  					imageQuery={(arts) => arts.fineartfields.fineseries === 'Portraits'} 
	  			/>
	  ...
	  <Container className="pad-row-bottom">
			...
			<Row>	
				...
				{finearts.nodes 
							...
							arts.fineartfields.fineseries === 'Portraits' ?
